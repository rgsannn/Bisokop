$((function () {
    ...
    if ("laravel" === $("body").attr("data-framework") && (o = $("body").attr("data-asset-path")), e.length) {
        var n = e.DataTable({
            ajax: "https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/app-assets/data/table-datatable.json",
            columns: [{
                data: "responsive_id"
            }, {
                data: "id"
        ...
        $("div.head-label").html('<h6 class="mb-0">Kelola Pengguna</h6>')
    }
